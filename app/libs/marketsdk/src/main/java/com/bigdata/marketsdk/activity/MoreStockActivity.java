...
/**
 * user:kun
 * Date:2016/11/4 or 下午10:57
 * email:hekun@gamil.com
 * Desc: 更多的跳转界面
 */

public class MoreStockActivity extends BaseActivity {
    ...
    protected void baseCreate(Bundle savedInstanceState) {
        ...
        num = getIntent().getIntExtra("SECT_ID",0);
        title = getIntent().getStringExtra("SECT_NAME");
        fenSHIModules = new ArrayList<>();
        codes = new ArrayList<>();


        adapter = new AbsAdapter<FenSHIModule>(this, fenSHIModules, R.layout.a_item_recylerview) {
            @Override
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.setClass(MoreStockActivity.this, StockActivity.class);
                            ...
                            public void onSuccess(String t) {
                                ...
                                RxVolley.get(Api.FENSHIBASE + fenSHIModule.getCode() + Api.A_K, new HttpCallback() {
                                    ...
                                    public void onSuccess(String t) {
                                        ...
                                        fenSHIModules.add(fenSHIModule);
                                        adapter.notifyDataSetChanged();
                                        LoadDialog.dismiss(MoreStockActivity.this);
                                    }
                                });
                            }
                        });
